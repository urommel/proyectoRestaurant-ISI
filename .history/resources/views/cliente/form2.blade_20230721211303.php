<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('tipoclientes_id', $tipo, $cliente->tipo_id, ['id' => 'tipoclientes_id', 'class' => 'form-control' . ($errors->has('tipoclientes_id') ? ' is-invalid' : ''), 'placeholder' => 'Tipo de Cliente', 'disabled' => 'disabled']) }}

            {!! $errors->first('tipoclientes_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
