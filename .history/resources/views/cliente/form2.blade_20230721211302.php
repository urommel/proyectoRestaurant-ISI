<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('tipoclientes_id', $tipo, $cliente->tipo_id, ['id' => 'tipoclientes_id', 'class' => 'form-control' . ($errors->has('tipo_id') ? ' is-invalid' : ''), 'placeholder' => 'Tipo de Cliente', 'disabled' => 'disabled']) }}
