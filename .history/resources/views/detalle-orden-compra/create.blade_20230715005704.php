               ...
               <div class="container card-body">
                <div class="row ">                 
                  <div class="col-6">
                    ...
                    <select class="form-control "  id="producto">
                      <option value="">Seleccione</option>
                       ...
                       <option value="{{$item->idproducto	}}_{{ $item->nombre }}_{{ $item->precio }}">{{$item->nombre}}</option> 
                    @endforeach
                    </select>
                  ...
                  <div class="col-6">
                    ...
                    <div class="col-8"></div>
                    <div class="col-4">
                        <input type="text"  style="width: 100%" class="form-control  float-right" id="total" name="total" value="0" readonly>
                    </div>
                </div>
        ...
        let cantidad = $('#cantidad').val();
          ...
          if (validate(producto[0])==true) {
            let row = '<tr id="row' + index + '"><td><input type="hidden" name="list_producto[]" value="' +
                producto[0] + '"><input type="hidden" name="list_cantidad[]" value="' + cantidad + '"><input type="hidden" name="list_precios[]" value="' + producto[2] + '">' + i++ +
                '</td><td>' + producto[1] + '</td><td>' + cantidad + '</td><td>'+producto[2]+'</td><td>'+producto[2]*cantidad+'</td><td><button onclick="remove(' +
                index + ' , ' + (producto[2] *
