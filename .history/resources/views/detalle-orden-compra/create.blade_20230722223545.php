                    ...
                    <div class="container card-body">
                        <div class="row ">
                            ...
                            <div class="col-6">
                                ...
                                <input id="precio" class="form-control" type="number" name="cantidad" value="0">
                            </div>
                            <div class=" col-6">
        ...
        $('#add').click(function(e) {
            ...
            if (validate(producto[0]) == true) {
                let row = '<tr id="row' + index + '"><td><input type="hidden" name="list_producto[]" value="' +
                    ...
                    '</td><td>' + producto[1] + '</td><td>' + cantidad + '</td><td>' + producto[2] + '</td><td>' +
                    producto[2] * cantidad + '</td><td><button onclick="remove(' +
                    index + ' , ' + (producto[2] *
