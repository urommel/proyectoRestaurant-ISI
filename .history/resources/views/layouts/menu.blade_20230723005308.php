...
{{-- <li class="dropdown">
    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">v
        <i class="fas fa-columns"></i>
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="nav-link" href="/categorias">
                <i class=" fas fa-building"></i><span>Plato Categoria</span>
            </a></li>
        <li><a class="nav-link" href="/platos">
                <i class=" fas fa-building"></i><span>Platillo</span>
            </a></li>
        <li><a class="nav-link" href="/tipos">
                <i class=" fas fa-building"></i><span>Tipo de Producto</span>
            </a></li>
        <li><a class="nav-link" href="/productos">
                <i class=" fas fa-building"></i><span>Producto</span>
            </a></li>
        <li><a class="nav-link" href="/tipomenus">
                <i class=" fas fa-building"></i><span>Tipo del Menu</span>
            </a></li>
        ...
        <li><a class="nav-link" href="/comandas">
                <i class=" fas fa-building"></i><span>Cliente-Comanda</span>
            </a></li>
    </ul>
...
<li class="nav-item dropdown {{ Request::is('home') ? 'active' : '' }}">
    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Gestionar Almacen</span></a>
        <ul class="dropdown-menu" >
            <li><a class="nav-link" href="/orden-compras">Orden de Compras</a></li>
            <li><a class="nav-link" href="/administradors">Evaluar OC</a></li>
            <li><a class="nav-link" href="/recepcions"">Gestionar Recepcion</a></li>
            <li><a class="nav-link" href="/orden-compras/index2"">Pagar OC</a></li>
        </ul>
</li>
