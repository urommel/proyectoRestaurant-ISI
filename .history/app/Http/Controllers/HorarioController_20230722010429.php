...
class HorarioController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('horario.show',  $horario->id)->with('mensaje', 'El horario ha sido actualizado exitosamente.');


        // Ejemplo de actualización de hora de inicio y hora de finalización
        $horario->hora_inicio = $request->input('hora_inicio');
        $horario->hora_fin = $request->input('hora_fin');
        $horario->save();

        // Redirecciona a la página de horarios existentes o a donde necesites
        return redirect()->route('ruta.horariosexistentes')->with('success', 'Horario actualizado correctamente');
