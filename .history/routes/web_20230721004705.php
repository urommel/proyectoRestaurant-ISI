...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('detallecomandas/create/{idComanda}',[DetallecomandaController::class, 'create'])->name('detallecomandas.create');
    Route::delete('detallecomandas/{idcomanda}/{idplato}',[DetallecomandaController::class, 'destroy'])->name('detallecomandas.destroy');
    Route::get('detallecomandas/update/{idcomanda}/{idplato}',[DetallecomandaController::class, 'show'])->name('detallecomandas.show');
    ...
    Route::delete('detalleproductos/{idcomanda}/{idprocudto}','App\Http\Controllers\DetalleproductoController::class, 'destroy')->name('detalleproductos.destroy');
