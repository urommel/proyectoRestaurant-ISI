...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::delete('detallecomandas/{comanda_id}/{plato_id}',[DetallecomandaController::class, 'destroy'])->name('detallecomandas.destroy');
    Route::get('detallecomandas/update/{comanda_id}/{plato_id}',[DetallecomandaController::class, 'show'])->name('detallecomandas.show');
    Route::get('detallecomandas/{comanda_id}/{plato_id}', [DetallecomandaController::class, 'edit'])->name('detallecomandas.edit');
    //detalle productos
    Route::get('detalleproductos/create/{comanda_id}',[DetalleproductoController::class, 'create'])->name('detalleproductos.create');
    Route::delete('detalleproductos/{comanda_id}/{idprocudto}',[DetalleproductoController::class, 'destroy'])->name('detalleproductos.destroy');
    Route::get('detalleproductos/update/{comanda_id}/{idprocudto}',[DetalleproductoController::class, 'show'])->name('detalleproductos.show');
    Route::get('detalleproductos/{comanda_id}/{idprocudto}',[DetalleproductoController::class, 'edit'])->name('detalleproductos.edit');
    //detalle menus
