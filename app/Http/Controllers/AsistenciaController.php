...
class AsistenciaController extends Controller
{
    ...
    {
        $this->middleware('permission:ver-asistencia|crear-asistencia|editar-asistencia|borrar-asistencia', ['only' => ['index']]);
        ...
        $this->middleware('permission:borrar-asistencia', ['only' => ['destroy']]);
    }
