...
class CompraController extends Controller
{
    ...
    {
        $ordenCompras = OrdenCompra::where('estado', 'Recibida')->get();
        $i =0;
    ...
    {
        OrdenCompra::where('idOrden', $request->idOrden)->update(['estado'=>'Pagada']);
        $ordenCompras = OrdenCompra::where('estado', 'Recibida')->get();
        $i =0;
        return view('compra.index', compact('ordenCompras','i'));
