                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('orden-compras.destroy',$ordenCompra->idOrden) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('recepcions.show',$ordenCompra->idOrden) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Recepcionar') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('recepcions.edit',$ordenCompra->idOrden) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Actualizar stock') }}</a>
                                                    @csrf
                                                    @method('DELETE')
