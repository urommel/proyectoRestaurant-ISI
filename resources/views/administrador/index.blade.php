                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('orden-compras.destroy',$ordenCompra->idOrden) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('administradors.show',$ordenCompra->idOrden) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('administradors.edit',$ordenCompra->idOrden) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
